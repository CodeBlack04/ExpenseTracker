...
class TransactionViewsTest(TestCase):
    ...
    def test_new_view(self):
        self.client.login(username='testuser', password='abcdABCD1234')
        response = self.client.get(reverse('transaction:new'))
        self.assertEqual(response.status_code, 200)
        ...
        response = self.client.post(reverse('transaction:new'), data1)
        self.assertEqual(response.status_code, 302)
        ...
        response = self.client.post(reverse('transaction:new'), data2)
    ...
    def test_list_without_login_view(self):
        ...
        self.assertEqual(response.status_code, 302)
        self.assertRedirects(response, reverse('core:login') + '?next=' + reverse('transaction:list'))
    ...
    def test_incomes_view(self):
        self.client.login(username='testuser', password='abcdABCD1234')
        response = self.client.get(reverse('transaction:incomes'))
        self.assertEqual(response.status_code, 200)
    ...
    def test_expenses_view(self):
        self.client.login(username='testuser', password='abcdABCD1234')
        response = self.client.get(reverse('transaction:expenses'))
        self.assertEqual(response.status_code, 200)
    ...
    def test_chart_data_view(self):
        self.client.login(username='testuser', password='abcdABCD1234')
        response = self.client.get(reverse('transaction:chart_data'))
        self.assertEqual(response.status_code, 200)
    ...
    def test_analytics_data_view(self):
        self.client.login(username='testuser', password='abcdABCD1234')
        response = self.client.get(reverse('transaction:analytics_data'))
        self.assertEqual(response.status_code, 200)
